...
export interface Config {
  ...
  collectionsSelect: {
    ...
    vienphi: VienphiSelect<false> | VienphiSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "vienphi".
 */
export interface Vienphi {
  id: string;
  hosobenhan?: (string | null) | MedicalRecod;
  sohoso?: string | null;
  bhyt?: ('co' | 'khong') | null;
  chietkhau?: ('tammuoi' | 'chinlam' | 'mottram') | null;
  ngaynhapvien?: string | null;
  ngayRaVien?: string | null;
  phinoitru?: string | null;
  thuoc?:
    | {
        tenthuoc?: (string | null) | Medication;
        soluong?: number | null;
    ...
    | null;
  chiphithuoc?: string | null;
  tong?: string | null;
  ngaythu?: string | null;
  nhanvien?: (string | null) | User;
  thanhtoan?: ('cash' | 'card') | null;
  ghichu?: string | null;
  updatedAt: string;
  createdAt: string;
}
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "vienphi_select".
 */
export interface VienphiSelect<T extends boolean = true> {
  hosobenhan?: T;
  sohoso?: T;
  bhyt?: T;
  chietkhau?: T;
